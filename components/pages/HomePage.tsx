...
export function HomePage() {
  ...
  const handlePageChange = (path: string) => router.push(path);
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {(pageContent.research_topics || []).map((topic: any) => (
                  <div
                    ...
                    onClick={() => handlePageChange(topic.path)}
                  >
          ...
          <ScrollAnimation>
            <section>
              <div className="flex justify-between items-end mb-12 border-b pb-6 border-border">
                ...
                <Button variant="ghost" className="text-primary hover:bg-primary/5 font-medium" onClick={() => handlePageChange('/publications')}>
          ...
          <ScrollAnimation>
            <section>
              <div className="flex justify-between items-end mb-12 border-b pb-6 border-border">
                ...
                <Button variant="ghost" className="text-primary hover:bg-primary/5 font-medium" onClick={() => handlePageChange('/board/news')}>
                  View All News →
                </Button>
              </div>
              ...
              {latestNews.length > 0 && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <div
                    ...
                    onClick={() => handlePageChange(latestNews[0].type === 'notice' ? `/board/news/${latestNews[0].id}` : `/board/gallery/${latestNews[0].id}`)}
                  >
                    <img
                  ...
                  <div className="flex flex-col gap-6">
                    {latestNews.slice(1, 4).map(item => (
                      <div
                        ...
                        onClick={() => handlePageChange(item.type === 'notice' ? `/board/news/${item.id}` : `/board/gallery/${item.id}`)}
                      >
