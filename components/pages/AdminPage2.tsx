...
import { EditIntroductionPageForm } from './EditIntroductionPageForm';
import { EditPopupPage } from './EditPopupPage';
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-start">
            ...
            <Button variant="link" onClick={() => router.push('/cmsl2004')}>← 게시물 관리 페이지로</Button>
          </div>
        </CardHeader>
        <CardContent>
